...
public class ClientBehaviour : MonoBehaviour
{
	...
	*/
	...
	void Start()
	{
		...
		// implicit bind since we do not need to bind to anything special
	...
	void FixedUpdate()
	{
		...
		ClientUI.UpdateStats(m_numPingsSent, m_lastPingTime);
		...
		if(ClientUI.ServerEndPoint.IsValid && !m_clientToServerConnection.IsCreated)
		{
			m_clientToServerConnection = m_ClientDriver.Connect(ClientUI.ServerEndPoint);
		}
